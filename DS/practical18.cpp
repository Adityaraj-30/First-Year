...
int main() //main function
{
	...
	int c1, d1;
	int mat[50][50] = {0};
	cout << "Enter the number of vertices: "; //input vertices
	cin >> v;
	cout << "Enter the number of edges: "; //input edges
	cin >> e;
	input(mat, e);
	PrintMat(mat, v);
	cout << "\n Enter the length of path" << endl; //input path length
	cin >> n;
	cout << "Enter the start point and the end point" << endl; //input start point
	cin >> a1 >> b1;
	c1 = (int)(a1)-97;
	d1 = (int)(b1)-97;
