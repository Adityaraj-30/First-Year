...
void without_per(char *a, int l, int r) //without permutation function
{
    int i;
    if (l == r)
        cout << a << "\n\n";
...
int main()
{
    ...
    while (choice == 'y' || choice == 'Y')
    {
        ...
        case 1:
            cout << endl
                 << "ALL PERMUTATION WITH REPEATATION OF " << nums << " ARE: " << endl;
            with_per(nums, permutations, len - 1, 0);
            break;
        case 2:
            cout << endl
                 << "ALL PERMUTATION WITHOUT REPEATATION OF " << nums << "ARE: " << endl;
            int n = strlen(nums);
