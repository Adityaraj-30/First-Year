/* 17)Write a Program to accept a directed graph G and compute the in-degree and 
...
void outDegree(int data[][3], int a); //for outdegree
void inDegree(int data[][3], int a);  //for indegree
